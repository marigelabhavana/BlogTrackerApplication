...
using BlogTrackerApplication.Controllers;
...
namespace TestProject
{
    public class Tests
    {
        ...
        public class TestClass
        {
            ...
            {
                // Arrange
                var options = new DbContextOptionsBuilder<BlogTrackerAppDbContext>()
                    .UseInMemoryDatabase(databaseName: "TestDatabase")
                    .Options;

                var mockContext = new Mock<BlogTrackerAppDbContext>(options);
